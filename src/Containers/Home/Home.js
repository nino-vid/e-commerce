...
const Home = props => {
  ...
  const handlePlayDice = () => {
    ...
    setTimeout(() => {
      setBrowsing(true);
      navigate(`/Game-Store/games/${randomSurname}`);
    }, 1500);
  }
                ...
                <div className={styles.container}>
                    <div className={styles.left}>
                        ...
                        <div className={styles.buttons}>
                              ...
                              <a href="https://bitbucket.org/sunt71692/game-store/src/main/" target="_blank"><button className={styles.cta} aria-label="View Repository">
                    ...
                    <div className={styles.right}>
                        <div className={styles.buttonsRight}>
                            ...
                            <a href='https://bitbucket.org/sunt71692/game-store/src/main/commit/' target="_blank"><button className={styles.cta} aria-label="Open commit log">
                              <Git className={styles.ctaSVG} />
                              Commit Log
                            </button></a>
                            <a href="https://bitbucket.org/sunt71692/game-store/src/main/README.md#performance" target="_blank"><button className={`${styles.cta} ${styles.lastChild}`} aria-label="Open performance test results">
                            ...
                            <a href="https://bitbucket.org/sunt71692/game-store/src/main/README.md#sources" target="_blank"><button className={`${styles.cta} ${styles.lastChild}`} aria-label="View Sources">
